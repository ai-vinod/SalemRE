  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold text-gray-800">Add New Blog Post</h1>
        <div className="flex space-x-2">
          ...
          <button
            ...
            disabled={loading}
          >
            <FiSave className="mr-2" /> {loading ? 'Saving...' : 'Save Post'}
          </button>
        </div>
      </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-3 text-sm text-gray-500">
                {blogPost.image ? blogPost.image.name : 'No file chosen'}
              </span>
            </div>
          </div>
