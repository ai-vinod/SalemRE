    ...
    const fetchPropertyDetails = async () => {
      ...
      try {
        ...
        setProperty({
          ...
          description: 'This premium plot is located in the heart of Ammapet, Salem. It offers excellent connectivity to major roads and is close to schools, hospitals, and shopping centers. The plot has a clear title and all necessary approvals. It is perfect for building your dream home or for investment purposes.',
          property_type: 'plot',
          price: 2500000,
          size: 2400,
          location: 'Ammapet, Salem',
          address: '123 Main Street, Ammapet, Salem, Tamil Nadu 636003',
          features: [
            'Corner Plot',
            'East Facing',
            'Near to Schools',
          ...
          agent: {
            name: 'Rajesh Kumar',
            phone: '+91 9876543210',
            email: 'rajesh@salemrealestate.com'
          },
          ...
          nearby: [
            { type: 'school', name: 'Government Higher Secondary School', distance: '0.5 km' },
            { type: 'hospital', name: 'Apollo Hospital', distance: '1.2 km' },
            { type: 'shopping', name: 'Reliance Mall', distance: '2 km' },
            { type: 'bus_stop', name: 'Ammapet Bus Stand', distance: '0.3 km' }
          ]
        })
      } finally {
        setLoading(false)
